...
/*====================================================================================================================================*
  ...
  PROTOCOLS                   For use by end users to retrieve the list of protocols available on the Zapper api
  CRYPTODEFI                  For use by end users to retrieve the list assets by defi protocol 
  CRYPTODEFIASSET             For use by end users to retrieve the balance by symbol/ticker given a defi protocol
  CRYPTODEFIVALUE             For use by end users to retrieve he USD amont lended by symbol/ticker given a defi protocol
